...
const TRANSLATIONS_TE = {
  ...
  "worker": "కార్మికుడు",
  "friend": "స్నేహితుడు",
  "Uploaded files": "అప్‌లోడ్ చేసిన ఫైల్‌లు",
  "Upload a CSV or bank statement PDF. Links inside files are treated as plain text.": "CSV లేదా బ్యాంక్ స్టేట్‌మెంట్ PDFని అప్‌లోడ్ చేయండి. ఫైల్‌లలోని లింక్‌లు సాదా వచనంగా పరిగణించబడతాయి.",
  "Tap to upload CSV or PDF": "CSV లేదా PDFని అప్‌లోడ్ చేయడానికి నొక్కండి",
  "or drag and drop. CSV or PDF, up to 5 MB.": "లేదా డ్రాగ్ అండ్ డ్రాప్. CSV లేదా PDF, గరిష్టంగా 5 MB.",
  "Manual income entry": "మాన్యువల్ ఆదాయ ప్రవేశం",
  "Date": "తేదీ",
  "Amount": "మొత్తం",
  "Source": "మూలం",
  "Platform credit": "ప్లాట్‌ఫారమ్ క్రెడిట్",
  ...
  "This is a simplified estimate. Consult a CA for accurate tax planning.": "ఇది సరళీకృత అంచనా. ఖచ్చితమైన పన్ను ప్రణాళిక కోసం CA ని సంప్రదించండి.",
  "Claim": "దావా వేయండి",
  "Claim Documents": "దావా పత్రాలు",
  "Step 3: Claim Documents": "దశ 3: పత్రాలను క్లెయిమ్ చేయండి",
  "Step 4: File a Claim": "దశ 4: దావా వేయండి",
  "Prepare these documents if you need to file a claim:": "మీరు దావా వేయాలంటే ఈ పత్రాలను సిద్ధం చేయండి:",
  "Follow these steps to file a claim on the official portal:": "అధికారిక పోర్టల్‌లో దావా వేయడానికి ఈ దశలను అనుసరించండి:",
  "Policy document / enrollment number": "విధాన పత్రం / నమోదు సంఖ్య",
  "Claim form (download from portal)": "దావా ఫారమ్ (పోర్టల్ నుండి డౌన్‌లోడ్ చేయండి)",
  "Supporting documents (hospital bills / death certificate)": "సహాయక పత్రాలు (ఆసుపత్రి బిల్లులు / మరణ ధృవీకరణ పత్రం)",
  "Download the claim form from the official portal.": "అధికారిక పోర్టల్ నుండి దావా ఫారమ్‌ను డౌన్‌లోడ్ చేయండి.",
  "Fill in the policyholder details and policy number.": "పాలసీదారు వివరాలను మరియు పాలసీ నంబర్‌ను పూరించండి.",
  "Attach all required supporting documents.": "అవసరమైన అన్ని సహాయక పత్రాలను అటాచ్ చేయండి.",
  "Submit the form at the nearest branch or online portal.": "ఫారమ్‌ను సమీప బ్రాంచ్ లేదా ఆన్‌లైన్ పోర్టల్‌లో సమర్పించండి.",
  ...
  "This is your dashboard. Here you'll see your income analysis, savings recommendations, and welfare scheme matches.": "ఇది మీ డాష్‌బోర్డ్. ఇక్కడ మీరు మీ ఆదాయ విశ్లేషణ, పొదుపు సిఫార్సులు మరియు సంక్షేమ పథకాల సరిపోలికలను చూస్తారు.",
  "Your daily earnings chart shows good days and bad days, helping you understand your income patterns.": "మీ రోజువారీ ఆదాయాల చార్ట్ మీ ఆదాయ విధానాలను అర్థం చేసుకోవడంలో మీకు మంచి రోజులు మరియు చెడు రోజులను చూపుతుంది.",
  "Use the smart savings suggestion and check which government schemes you qualify for.": "స్మార్ట్ సేవింగ్స్ సూచనను ఉపయోగించండి మరియు మీరు ఏ ప్రభుత్వ పథకాలకు అర్హత పొందారో తనిఖీ చేయండి.",
  "Tap Upload to add more statements or manual entries anytime.": "ఎప్పుడైనా మరిన్ని స్టేట్‌మెంట్‌లు లేదా మాన్యువల్ ఎంట్రీలను జోడించడానికి అప్‌లోడ్ నొక్కండి.",
  "Remove": "తొలగించు",
  "Please upload a CSV or PDF file.": "దయచేసి CSV లేదా PDF ఫైల్‌ను అప్‌లోడ్ చేయండి.",
  "Bank PDF": "బ్యాంక్ PDF",
  "Ration card": "రేషన్ కార్డు",
  "Voter ID": "ఓటరు ID",
  "Driving license": "డ్రైవింగ్ లైసెన్స్",
  "Income certificate": "ఆదాయ ధృవీకరణ పత్రం",
  "Minimum age": "కనీస వయస్సు",
  "Maximum age": "గరిష్ట వయస్సు",
  "Minimum monthly income": "కనీస నెలవారీ ఆదాయం",
  "Income must be below": "ఆదాయం తక్కువగా ఉండాలి",
  "Occupation must be": "వృత్తి ఉండాలి",
  "State must be": "రాష్ట్రం ఉండాలి",
  ...
  "Pension, family pension, education assistance, accident relief": "పెన్షన్, కుటుంబ పెన్షన్, విద్య సహాయం, ప్రమాద ఉపశమనం",
  ...
  "Check which government schemes you qualify for based on your profile and income.": "మీ ప్రొఫైల్ మరియు ఆదాయం ఆధారంగా మీరు ఏ ప్రభుత్వ పథకాలకు అర్హత పొందారో తనిఖీ చేయండి.",
  ...
  "Set personal saving targets for emergencies, festivals, or big purchases.": "అత్యవసర పరిస్థితులు, పండుగలు లేదా పెద్ద కొనుగోళ్ల కోసం వ్యక్తిగత పొదుపు లక్ష్యాలను సెట్ చేయండి.",
  ...
  "Track your spending by category and set budgets to stay in control.": "వర్గం వారీగా మీ ఖర్చును ట్రాక్ చేయండి మరియు నియంత్రణలో ఉండటానికి బడ్జెట్‌లను సెట్ చేయండి.",
  "Generate a portable summary of your verified profile to share with employers or schemes.": "యజమానులు లేదా స్కీమ్‌లతో భాగస్వామ్యం చేయడానికి మీ ధృవీకరించబడిన ప్రొఫైల్ యొక్క పోర్టబుల్ సారాంశాన్ని రూపొందించండి.",
...
const TRANSLATIONS_MR = {
  ...
  "Understand your earnings variance, good days vs bad days, and average monthly income instantly.": "तुमच्या कमाईतील फरक, चांगले दिवस विरुद्ध वाईट दिवस आणि सरासरी मासिक उत्पन्न त्वरित समजून घ्या.",
  ...
  "Any 4 digits will work in this prototype.": "या प्रोटोटाइपमध्ये कोणतेही 4 अंक काम करतील.",
  ...
  "Basic details for matching": "जुळणीसाठी मूलभूत तपशील",
  "Age": "वय",
  "Occupation": "व्यवसाय",
  "State": "राज्य",
  ...
  "Export your secure worker profile": "तुमचे सुरक्षित कर्मचारी प्रोफाइल निर्यात करा",
  ...
  "Apply": "अर्ज करा",
  "Back": "मागे",
  "Step 1: Check Required Documents": "पायरी 1: आवश्यक कागदपत्रे तपासा",
  ...
  "You are now ready to visit the official website of the": "तुम्ही आता अधिकृत वेबसाइटला भेट देण्यासाठी तयार आहात",
  ...
  "Pradhan Mantri Shram Yogi Maan-dhan": "प्रधान मंत्री श्रम योगी मान-धन",
  ...
  "Welfare benefits for registered construction workers": "नोंदणीकृत बांधकाम कामगारांसाठी कल्याणकारी लाभ",
  "PM SVANidhi": "पीएम स्वनिधी",
  "MUDRA Loan (Shishu)": "मुद्रा कर्ज (शिशू)",
  ...
  "OTP digit 2": "OTP अंक 2",
  "OTP digit 3": "OTP अंक 3",
  "OTP digit 4": "OTP अंक ४",
  "OTP digit 5": "OTP अंक 5",
  "OTP digit 6": "OTP अंक 6",
  "Demo code:": "डेमो कोड:",
  ...
  "Row": "रांग",
  "Issue": "समस्या",
  "Add at least one valid credit/income row to continue.": "सुरू ठेवण्यासाठी किमान एक वैध क्रेडिट/उत्पन्न पंक्ती जोडा.",
  ...
  "Please upload a CSV file.": "कृपया एक CSV फाइल अपलोड करा.",
  ...
  "File is larger than 5 MB.": "फाइल 5 MB पेक्षा मोठी आहे.",
  "Log Out": "लॉग आउट",
  "Kaam Card - ": "काम कार्ड - ",
  "worker": "कामगार",
  "friend": "मित्र",
  ...
  "Step 4: File a Claim": "पायरी 4: दावा दाखल करा",
  ...
  "Policy document / enrollment number": "पॉलिसी दस्तऐवज / नावनोंदणी क्रमांक",
  ...
  "Create a goal to save for emergencies, festivals, or big purchases.": "आणीबाणी, सण किंवा मोठ्या खरेदीसाठी बचत करण्याचे ध्येय तयार करा.",
  "Government of India": "भारत सरकार",
  "Welfare benefits, pension, accident cover for construction workers": "बांधकाम कामगारांसाठी कल्याण लाभ, पेन्शन, अपघात कव्हर",
  "Pension, health insurance, accident cover for unorganised workers": "असंघटित कामगारांसाठी पेन्शन, आरोग्य विमा, अपघात संरक्षण",
  ...
  "Check which government schemes you qualify for based on your profile and income.": "तुमच्या प्रोफाइल आणि उत्पन्नाच्या आधारे तुम्ही कोणत्या सरकारी योजनांसाठी पात्र आहात ते तपासा.",
  ...
  "Generate a portable summary of your verified profile to share with employers or schemes.": "नियोक्ता किंवा योजनांसोबत शेअर करण्यासाठी तुमच्या सत्यापित प्रोफाइलचा पोर्टेबल सारांश तयार करा.",
